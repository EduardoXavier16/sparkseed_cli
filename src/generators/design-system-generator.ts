import { BreakpointSystem, ColorSystem, ComponentSpec, DesignGuidelines, DesignSystem, ProjectConfig, SpacingSystem, SupportedLanguage, TypographySystem } from '../types';
...
interface IDesignSystemLocaleTexts {
  readonly headings: IDesignSystemLocaleHeadings;
  readonly labels: IDesignSystemLocaleLabels;
}

const DESIGN_SYSTEM_LOCALE_TEXTS: Record<SupportedLanguage, IDesignSystemLocaleTexts> = {
  en: {
    headings: {
      title: 'Design System',
      colors: 'Colors',
    ...
    labels: {
      ...
      colorSystemDescription: 'The color system is based on a semantic palette that makes maintenance easier and ensures visual consistency.',
    },
  },
  pt: {
    headings: {
    ...
    labels: {
      ...
      colorSystemDescription: 'O sistema de cores é baseado em uma paleta semântica que facilita a manutenção e garante consistência visual.',
    },
  },
  es: {
    headings: {
    ...
    labels: {
      ...
      colorSystemDescription: 'El sistema de color se basa en una paleta semántica que facilita el mantenimiento y garantiza la consistencia visual.',
    },
  },
};
